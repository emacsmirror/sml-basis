...
(define-syntax-rule (add-to var which url)
...
(define (input-url url)
  (match (split-url url)
    ((list "SIG" ":" which ":" "=" ":" "VAL" ":" "SPEC")  ; hack for ":="
     (add-to sml-basis-data-values which url))
    ((list "SIG" ":" which ":" "VAL" ":" "SPEC")
     (add-to sml-basis-data-values which url))
    ((list "SIG" ":" which ":" "STR" ":" "SPEC")
     (add-to sml-basis-data-structures which url))
    ((list "SIG" ":" which ":" "EXN" ":" "SPEC")
     (add-to sml-basis-data-exceptions which url))
    ((list "SIG" ":" which ":" "TY"  ":" "SPEC")
     (add-to sml-basis-data-types which url))
    ...
    ((list "ARG" ":" which ":" "TY"  ":" "SPEC")
     (add-to sml-basis-data-types which url))
    ((list which ":" "FCT" ":" "SPEC")
     (add-to sml-basis-data-functors which url))
    ((list which ":" "SIG" ":" "SPEC")
     (add-to sml-basis-data-signatures which url))
    ((list which ":" "STR" ":" "SPEC")
     (add-to sml-basis-data-structures which url))
    (else
